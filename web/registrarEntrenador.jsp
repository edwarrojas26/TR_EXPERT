<%-- Document : registrarEntrenador Created on : 19/09/2022, 10:14:49 AM Author : edwar --%>
                ...
                <form method="post" action="Usuario">
                    ...
                    <div class="form-row mb-2">
                        ...
                        <div class="form-group col-md-6">
                            <label class="font-weight-bold" for="txtNumDoc">Numero de documento <span
                                    class="text-danger">*</span></label>
                            <input type="text" name="txtNumDoc" class="form-control"
                                placeholder="Tu numero de documento"><br>
                    ...
                    <form action="Entrenador" method="POST">
                        ...
                        <input type="text" name="txtArea" class="form-control"
                            placeholder="Area de desempeño entrenador">
