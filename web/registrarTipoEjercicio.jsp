...
<html lang="en">
    ...
    <body class="">
        ...
        <section class="home">
            ...
            <button><a href="./modal2.jsp" class="btn btn-success">Agregar</a></button>
            <br> <br>
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
                        <div class="table-responsive">        
                            <table id="example" class="table table-striped table-secunday" style="width:100%">
                                ...
                                <thead>
                                    ...
                                    <tr class="bg-danger">
                                        ...
                                        <th class="bg-danger">Descripcion</th>
                                        <th class="bg-danger">Series</th>
                                        <th class="bg-danger">Repeticiones</th>
                                        <th class="bg-danger">Descansos</th>
                                    </tr>
