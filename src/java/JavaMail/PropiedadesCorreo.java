...
public class PropiedadesCorreo {
    ...
    public static void envioCorreo(String host, String puerto, final String usuarioCorreo, final String clave, String direccion, String asunto, String mensaje) throws AddressException, MessagingException {
